...
export class WaterJugController {
    ...
    @ApiResponse(
        {
            status: 200, description: 'Solución calculada correctamente', type: Object
        }
    )
    @ApiResponse(
        {
            status: 400, description: 'Datos de entrada no válidos'
        }
    )
    @ApiBody(
        {
    ...
    computeWaterJug
        ...
        return this.waterJugService.waterJugSolver
            (
                x_capacity,
                y_capacity,
                z_amount_wanted
